...
const AudioSpectralizer = ({ audioElement, isPlaying }) => {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      {/* Nudge */}
      <div
        className={`custom-font z-40 pointer-events-none transition-all duration-500 ease-in-out absolute top-3 left-1/2 -translate-x-1/2
          ${showNudge && !isPlaying ? "opacity-100 translate-y-0" : "opacity-0 translate-y-1"}
        `}
      >
