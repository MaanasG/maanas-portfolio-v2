...
const LoadingScreen = ({ onLoadComplete }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[var(--almost-black)] z-50 flex items-center justify-center">
      {/* Background pattern */}
      ...
      <div className="relative z-10 text-center">
        {/* Main logo/name */}
        <div className="mb-8">
          <h1 className="font-black text-[var(--off-white)] custom-font tracking-tighter text-6xl md:text-8xl lg:text-9xl">
            MAANAS
          </h1>
          <h2 className="font-black text-[var(--off-white)] custom-font tracking-tighter text-lg md:text-2xl lg:text-3xl -mt-2">
            GOPI
          </h2>
        </div>
        ...
        {/* Loading text */}
        <p className="coolvetica-font text-gray-300 text-sm uppercase tracking-wide">
